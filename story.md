...
```sh
function u { echo 'https://raw.githubusercontent.com/jeff-hykin/universify/84436cdc65e38ddfe0da275541075575fde88dfe/run/hello_world.js'; };$Env:_u=$(u) || export _u=$(u); irm "$(u)"|iex || clear;curl -fsSL "$_u" | sh
```
