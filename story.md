...
```sh
function iex { alias irm='curl -fsSL $_u | sh ;: ';iex(){ cat;};eval "export ${1#?}";};iex '$_u="https://raw.githubusercontent.com/jeff-hykin/universify/696ec9d76554848c82361723c7966baa8394730d/run/hello_world.js";irm $_u|iex'
```
