...
```sh
function u { echo 'https://raw.githubusercontent.com/jeff-hykin/universify/b8271566b9b859bb41d1f47c9e47d26df74c1ac0/run/hello_world.js'; };$Env:_u=$(u) || export _u=$(u); irm "$(u)"|iex || clear;curl -fsSL "$_u" | sh
```
